...
#ifndef H_MALI_UTGARD_H
#define H_MALI_UTGARD_H
...
#define MALI_GPU_RESOURCES_MALI400_MP1(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq)                            \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
                                  pp0_mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq)      \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
                                  pp0_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(1, (base_addr) + MALI_OFFSET_PP1, pp1_irq, (base_addr) + MALI_OFFSET_PP1_MMU,        \
                                  pp1_mmu_irq)
...
#define MALI_GPU_RESOURCES_MALI400_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq)                                                           \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI400_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(1, (base_addr) + MALI_OFFSET_PP1, pp1_irq, (base_addr) + MALI_OFFSET_PP1_MMU,        \
                                  pp1_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(2, (base_addr) + MALI_OFFSET_PP2, pp2_irq, (base_addr) + MALI_OFFSET_PP2_MMU,        \
                                  pp2_mmu_irq)

#define MALI_GPU_RESOURCES_MALI400_MP3_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq)                                                       \
    MALI_GPU_RESOURCES_MALI400_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq)                                                                        \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI400_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq)                                     \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI400_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
                                  pp0_mmu_irq)                                                                         \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(2, (base_addr) + MALI_OFFSET_PP2, pp2_irq, (base_addr) + MALI_OFFSET_PP2_MMU,        \
                                  pp2_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(3, (base_addr) + MALI_OFFSET_PP3, pp3_irq, (base_addr) + MALI_OFFSET_PP3_MMU,        \
                                  pp3_mmu_irq)

#define MALI_GPU_RESOURCES_MALI400_MP4_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq)                                 \
    MALI_GPU_RESOURCES_MALI400_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp3_irq, pp3_mmu_irq)                                                  \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

/* Mali-450 */
#define MALI_GPU_RESOURCES_MALI450_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp_bcast_irq)                                                                   \
...
#define MALI_GPU_RESOURCES_MALI450_MP2_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp_bcast_irq)                                                               \
    MALI_GPU_RESOURCES_MALI450_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,          \
                                   pp_bcast_irq)                                                                       \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI450_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp_bcast_irq)                                             \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
...
#define MALI_GPU_RESOURCES_MALI450_MP3_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp_bcast_irq)                                         \
    MALI_GPU_RESOURCES_MALI450_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp_bcast_irq)                                                          \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI450_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                       \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
...
#define MALI_GPU_RESOURCES_MALI450_MP4_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                   \
    MALI_GPU_RESOURCES_MALI450_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                                    \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI450_MP6(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq,      \
                                       pp5_mmu_irq, pp_bcast_irq)                                                      \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(3, (base_addr) + MALI_OFFSET_PP4, pp3_irq, (base_addr) + MALI_OFFSET_PP4_MMU,        \
                                  pp3_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(4, (base_addr) + MALI_OFFSET_PP5, pp4_irq, (base_addr) + MALI_OFFSET_PP5_MMU,        \
                                  pp4_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(5, (base_addr) + MALI_OFFSET_PP6, pp5_irq, (base_addr) + MALI_OFFSET_PP6_MMU,        \
                                  pp5_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_BCAST((base_addr) + MALI_OFFSET_BCAST)                                                           \
    MALI_GPU_RESOURCE_DLBU((base_addr) + MALI_OFFSET_DLBU)                                                             \
    MALI_GPU_RESOURCE_PP_BCAST((base_addr) + MALI_OFFSET_PP_BCAST, pp_bcast_irq)                                       \
...
#define MALI_GPU_RESOURCES_MALI450_MP6_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq,  \
                                           pp5_mmu_irq, pp_bcast_irq)                                                  \
    MALI_GPU_RESOURCES_MALI450_MP6(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq, pp5_mmu_irq,      \
                                   pp_bcast_irq)                                                                       \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI450_MP8(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq,      \
                                       pp5_mmu_irq, pp6_irq, pp6_mmu_irq, pp7_irq, pp7_mmu_irq, pp_bcast_irq)          \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE0)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
    ...
    MALI_GPU_RESOURCE_PP_WITH_MMU(3, (base_addr) + MALI_OFFSET_PP3, pp3_irq, (base_addr) + MALI_OFFSET_PP3_MMU,        \
                                  pp3_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI450_OFFSET_L2_CACHE2)                                                       \
    MALI_GPU_RESOURCE_PP_WITH_MMU(4, (base_addr) + MALI_OFFSET_PP4, pp4_irq, (base_addr) + MALI_OFFSET_PP4_MMU,        \
                                  pp4_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(5, (base_addr) + MALI_OFFSET_PP5, pp5_irq, (base_addr) + MALI_OFFSET_PP5_MMU,        \
                                  pp5_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(6, (base_addr) + MALI_OFFSET_PP6, pp6_irq, (base_addr) + MALI_OFFSET_PP6_MMU,        \
                                  pp6_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_PP_WITH_MMU(7, (base_addr) + MALI_OFFSET_PP7, pp7_irq, (base_addr) + MALI_OFFSET_PP7_MMU,        \
                                  pp7_mmu_irq)                                                                         \
    MALI_GPU_RESOURCE_BCAST((base_addr) + MALI_OFFSET_BCAST)                                                           \
    MALI_GPU_RESOURCE_DLBU((base_addr) + MALI_OFFSET_DLBU)                                                             \
    MALI_GPU_RESOURCE_PP_BCAST((base_addr) + MALI_OFFSET_PP_BCAST, pp_bcast_irq)                                       \
...
#define MALI_GPU_RESOURCES_MALI450_MP8_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq,  \
                                           pp5_mmu_irq, pp6_irq, pp6_mmu_irq, pp7_irq, pp7_mmu_irq, pp_bcast_irq)      \
    MALI_GPU_RESOURCES_MALI450_MP8(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp4_irq, pp4_mmu_irq, pp5_irq, pp5_mmu_irq,      \
                                   pp6_irq, pp6_mmu_irq, pp7_irq, pp7_mmu_irq, pp_bcast_irq)                           \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)
...
#define MALI_GPU_RESOURCES_MALI470_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp_bcast_irq)                                                                   \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI470_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
...
#define MALI_GPU_RESOURCES_MALI470_MP2_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp_bcast_irq)                                                               \
    MALI_GPU_RESOURCES_MALI470_MP2(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,          \
                                   pp_bcast_irq)                                                                       \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI470_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp_bcast_irq)                                             \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI470_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
...
#define MALI_GPU_RESOURCES_MALI470_MP3_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp_bcast_irq)                                         \
    MALI_GPU_RESOURCES_MALI470_MP3(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp_bcast_irq)                                                          \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)

#define MALI_GPU_RESOURCES_MALI470_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,      \
                                       pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                       \
    MALI_GPU_RESOURCE_L2((base_addr) + MALI470_OFFSET_L2_CACHE1)                                                       \
    MALI_GPU_RESOURCE_GP_WITH_MMU((base_addr) + MALI_OFFSET_GP, gp_irq, (base_addr) + MALI_OFFSET_GP_MMU, gp_mmu_irq)  \
    MALI_GPU_RESOURCE_PP_WITH_MMU(0, (base_addr) + MALI_OFFSET_PP0, pp0_irq, (base_addr) + MALI_OFFSET_PP0_MMU,        \
...
#define MALI_GPU_RESOURCES_MALI470_MP4_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq,  \
                                           pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                   \
    MALI_GPU_RESOURCES_MALI470_MP4(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, \
                                   pp2_mmu_irq, pp3_irq, pp3_mmu_irq, pp_bcast_irq)                                    \
    MALI_GPU_RESOURCE_PMU((base_addr) + MALI_OFFSET_PMU)
...
struct mali_gpu_utilization_data {
    unsigned int
        utilization_gpu; /* Utilization for GP and all PP cores combined, 0 = no utilization, 256 = full utilization */
