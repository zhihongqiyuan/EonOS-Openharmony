...
#ifndef ES2PANDA_UTIL_INCLUDE_IMPORT_EXPRESSION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_IMPORT_EXPRESSION_BUILDER
...
public:
    ...
    ImportExpression *Build()
    {
        auto *node = AllocNode(source_);
        return node;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_IMPORT_EXPRESSION_BUILDER