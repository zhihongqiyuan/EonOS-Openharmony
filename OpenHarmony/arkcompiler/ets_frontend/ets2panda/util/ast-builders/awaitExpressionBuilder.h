...
#ifndef ES2PANDA_UTIL_INCLUDE_AWAIT_EXPRESSION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_AWAIT_EXPRESSION_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_AWAIT_EXPRESSION_BUILDER