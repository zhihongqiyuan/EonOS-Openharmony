...
#ifndef ES2PANDA_UTIL_INCLUDE_ETS_PACKAGE_DECLARATION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_ETS_PACKAGE_DECLARATION_BUILDER
...
public:
    ...
    ETSPackageDeclaration *Build()
    {
        auto node = AllocNode(name_);
        return node;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_ETS_PACKAGE_DECLARATION_BUILDER