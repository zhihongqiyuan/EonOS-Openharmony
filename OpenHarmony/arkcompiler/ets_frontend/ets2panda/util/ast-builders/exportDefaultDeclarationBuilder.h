...
#ifndef ES2PANDA_UTIL_INCLUDE_EXPORT_DEFAULT_DECLARATION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_EXPORT_DEFAULT_DECLARATION_BUILDER
...
public:
    ...
    ExportDefaultDeclarationBuilder &SetExportEquals(bool val)
    {
        exportEquals_ = val;
        return *this;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_EXPORT_DEFAULT_DECLARATION_BUILDER