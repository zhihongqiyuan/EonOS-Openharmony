...
#ifndef ES2PANDA_UTIL_INCLUDE_TS_INTERSECTION_TYPE_BUILDER
#define ES2PANDA_UTIL_INCLUDE_TS_INTERSECTION_TYPE_BUILDER
...
public:
    ...
    TSIntersectionTypeBuilder &AddExpression(Expression *type)
    {
        types_.emplace_back(type);
        return *this;
    }

    TSIntersectionType *Build()
    {
...
#endif  // ES2PANDA_UTIL_INCLUDE_TS_INTERSECTION_TYPE_BUILDER