...
#ifndef ES2PANDA_UTIL_INCLUDE_ETS_PRIMITIVE_TYPE_BUILDER
#define ES2PANDA_UTIL_INCLUDE_ETS_PRIMITIVE_TYPE_BUILDER
...
private:
    PrimitiveType type_ = PrimitiveType::VOID;
};

}  // namespace ark::es2panda::ir
#endif  // ES2PANDA_UTIL_INCLUDE_ETS_PRIMITIVE_TYPE_BUILDER