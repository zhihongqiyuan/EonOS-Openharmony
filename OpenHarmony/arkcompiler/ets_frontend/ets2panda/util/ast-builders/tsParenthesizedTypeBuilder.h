...
#ifndef ES2PANDA_UTIL_INCLUDE_TS_PARENTHESIZED_TYPE_BUILDER
#define ES2PANDA_UTIL_INCLUDE_TS_PARENTHESIZED_TYPE_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_TS_PARENTHESIZED_TYPE_BUILDER