...
#ifndef ES2PANDA_UTIL_INCLUDE_TS_OBJECT_KEYWORD_BUILDER
#define ES2PANDA_UTIL_INCLUDE_TS_OBJECT_KEYWORD_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_TS_OBJECT_KEYWORD_BUILDER