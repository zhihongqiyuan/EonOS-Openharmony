...
#ifndef ES2PANDA_UTIL_INCLUDE_BREAK_STATEMENT_BUILDER
#define ES2PANDA_UTIL_INCLUDE_BREAK_STATEMENT_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_BREAK_STATEMENT_BUILDER