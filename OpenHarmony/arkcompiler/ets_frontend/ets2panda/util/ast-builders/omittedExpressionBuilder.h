...
#ifndef ES2PANDA_UTIL_INCLUDE_OMITTED_EXPRESSION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_OMITTED_EXPRESSION_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_OMITTED_EXPRESSION_BUILDER