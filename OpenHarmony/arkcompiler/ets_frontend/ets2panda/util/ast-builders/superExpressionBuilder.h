...
#ifndef ES2PANDA_UTIL_INCLUDE_SUPER_EXPRESSION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_SUPER_EXPRESSION_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_SUPER_EXPRESSION_BUILDER