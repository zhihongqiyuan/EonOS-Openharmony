...
#ifndef ES2PANDA_UTIL_INCLUDE_ETS_NEW_ARRAY_INSTANCE_EXPRESSION_BUILDER
#define ES2PANDA_UTIL_INCLUDE_ETS_NEW_ARRAY_INSTANCE_EXPRESSION_BUILDER
...
public:
    ...
    ETSNewArrayInstanceExpressionBuilder &SetTypeReference(Expression *dimension)
    {
        dimension_ = dimension;
        return *this;
    }

    ETSNewArrayInstanceExpression *Build()
    {
        auto node = AllocNode(typeReference_, dimension_);
        return node;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_ETS_NEW_ARRAY_INSTANCE_EXPRESSION_BUILDER