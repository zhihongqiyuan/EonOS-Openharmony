...
#ifndef ES2PANDA_UTIL_INCLUDE_ETS_CLASS_LITERAL_BUILDER
#define ES2PANDA_UTIL_INCLUDE_ETS_CLASS_LITERAL_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_ETS_CLASS_LITERAL_BUILDER