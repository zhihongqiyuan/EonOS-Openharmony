...
#ifndef ES2PANDA_UTIL_INCLUDE_WHILE_STATEMENT_BUILDER
#define ES2PANDA_UTIL_INCLUDE_WHILE_STATEMENT_BUILDER
...
public:
    ...
    WhileStatementBuilder &SetBody(Statement *body)
    {
        body_ = body;
        return *this;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_WHILE_STATEMENT_BUILDER