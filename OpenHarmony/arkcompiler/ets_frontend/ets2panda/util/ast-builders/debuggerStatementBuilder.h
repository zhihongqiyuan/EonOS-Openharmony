...
#ifndef ES2PANDA_UTIL_INCLUDE_DEBUGGER_STATEMENT_BUILDER
#define ES2PANDA_UTIL_INCLUDE_DEBUGGER_STATEMENT_BUILDER
...
#endif  // ES2PANDA_UTIL_INCLUDE_DEBUGGER_STATEMENT_BUILDER