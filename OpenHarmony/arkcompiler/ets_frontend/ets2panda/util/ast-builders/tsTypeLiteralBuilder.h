...
#ifndef ES2PANDA_UTIL_INCLUDE_TS_TYPE_LITERAL_BUILDER
#define ES2PANDA_UTIL_INCLUDE_TS_TYPE_LITERAL_BUILDER
...
public:
    ...
    TSTypeLiteral *Build()
    {
        auto node = AllocNode(std::move(members_));
        return node;
    }
...
#endif  // ES2PANDA_UTIL_INCLUDE_TS_TYPE_LITERAL_BUILDER