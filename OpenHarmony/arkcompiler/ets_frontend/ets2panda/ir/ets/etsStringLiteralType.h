...
#ifndef ES2PANDA_IR_ETS_STRING_TYPE_H
#define ES2PANDA_IR_ETS_STRING_TYPE_H
...
public:
    ...
    [[nodiscard]] ETSStringLiteralType *Clone(ArenaAllocator *allocator, AstNode *parent) override;
