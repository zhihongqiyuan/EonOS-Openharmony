...
function foo11(Para1 ?:(Para1: number) => void): void {}

function foo12(Para1: number): (Para1: string) => number { return () => 0; }

interface MyInterface {
  Para1?: (Para1: number) => string;
}

function foo13(Para1?: (Para1: (Para1: string) => void) => void): void {}
...
function foo17(Para3?: (Para3: number) => (Para3: string) => boolean): void {}
