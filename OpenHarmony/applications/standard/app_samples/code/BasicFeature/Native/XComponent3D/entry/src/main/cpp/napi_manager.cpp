...
void NapiManager::MainOnMessage(const uv_async_t *req) { LOGD("MainOnMessage Triggered"); }
...
void NapiManager::OnShowNative() { LOGD("NapiManager::OnShowNative"); }

void NapiManager::OnHideNative() { LOGD("NapiManager::OnHideNative"); }

void NapiManager::OnDestroyNative() { LOGD("NapiManager::OnDestroyNative"); }
...
void NapiManager::OnPageShowNative() { LOGD("NapiManager::OnPageShowNative"); }

void NapiManager::OnPageHideNative() { LOGD("NapiManager::OnPageHideNative"); }