# ArkTS使用JSVM-API接口进行ArrayBuffer相关开发
...
- [使用JSVM-API接口进行ArrayBuffer相关开发](https://docs.openharmony.cn/pages/v5.0/zh-cn/application-dev/napi/use-jsvm-about-arraybuffer.md)

### 效果预览

|                                   首页                                   |                            执行及结果即时反馈                            |
| :----------------------------------------------------------------------: | :----------------------------------------------------------------------: |
| <img src="./screenshots/JsvmAboutArraybuffer_1.png" style="zoom:33%;" /> | <img src="./screenshots/JsvmAboutArraybuffer_2.png" style="zoom:33%;" /> |
