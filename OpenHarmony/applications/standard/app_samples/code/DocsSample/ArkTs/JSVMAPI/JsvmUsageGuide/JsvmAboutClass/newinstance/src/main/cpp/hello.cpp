...
// [Start oh_jsvm_newinstance]
#include <string>
// [StartExclude oh_jsvm_newinstance]
...
// [EndExclude oh_jsvm_newinstance]
...
// [End oh_jsvm_newinstance]

const char *SRC_CALL_NATIVE = R"JS( function Fruit(name) { this.name = name; } newInstance(Fruit, "apple"); )JS";
