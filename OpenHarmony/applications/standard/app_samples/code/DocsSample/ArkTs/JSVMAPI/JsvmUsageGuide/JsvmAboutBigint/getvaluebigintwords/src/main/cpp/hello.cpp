...
// [Start oh_jsvm_get_value_bigint_words]
#include "napi/native_api.h"
#include "hilog/log.h"
#include "ark_runtime/jsvm.h"
#include <cstdlib>
// [StartExclude oh_jsvm_get_value_bigint_words]
...
// [EndExclude oh_jsvm_get_value_bigint_words]
...
static JSVM_Value GetValueBigintWords(JSVM_Env env, JSVM_CallbackInfo info)
{
    ...
    if (wordCount == 0 || wordCount > SOME_REASONABLE_MAX) {
...
// [End oh_jsvm_get_value_bigint_words]
...
static napi_module demoModule = {
    ...
    .nm_modname = "getvaluebigintwords",
    .nm_priv = ((void *)0),
    .reserved = {0},
};
