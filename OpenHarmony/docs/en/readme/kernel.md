...
For more information about Linux LTS 5.10.y, visit the [official kernel website](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?h=linux-6.16.y).

For more information about Linux LTS 6.6.y, visit the [official kernel website](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?h=linux-6.16.y).
...
│	│	│   └── hi3516dv300_patch
│	│	│   │		└── hi3516dv300.patch		# linux-6.16 Hi3516D V300 SOC patches
│	│	│   └── rkrk3568_patch
│	│	│   		├── kernel.patch		# linux-6.16 rk3568 SOC patches
│	│	│   		└── hdf.patch			# linux-6.16 rk3568 customized HDF patches
│	│	└── linux-6.16
│	│	    └── rkrk3568_patch
│	│	    		├── kernel.patch		# linux-6.16 rk3568 SOC patches
│	│	    		└── hdf.patch			# linux-6.16 rk3568 customized HDF patches
...
./build.sh --product-name rk3568					# Build the rk3568 image.
    --gn-args linux_kernel_version="linux-6.16"		# Build the specified kernel version.
```
