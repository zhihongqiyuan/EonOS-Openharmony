...
const { main: arkTsLinter } = entrypointBuildTask({
    name: "linter",
    buildDeps: [generateDiagnostics],
    project: "src/linter",
    srcEntrypoint: "./src/linter/linter.ts",
    builtEntrypoint: "./built/local/linter/linter.js",
    output: "./built/local/linter.js",
    bundlerOptions: {
...
const { main: tsc, watch: watchTsc } = entrypointBuildTask({
    ...
    mainDeps: [generateLibs, arkTsLinter],
    bundlerOptions: {
        // Ensure we never drop any dead code, which might be helpful while debugging.
        treeShaking: false,
        // These are directly imported via import statements and should not be bundled.
...
const ohTestCasesGeneration = task({
    name: "ohTestCasesGeneration",
    description: "Generate oh test cases",
    run: async () => {
...
const { main: tests, watch: watchTests } = entrypointBuildTask({
    ...
    output: testRunner,
    mainDeps: [generateLibs, arkTsLinter, ohTestCasesGeneration],
    bundlerOptions: {
        // Ensure we never drop any dead code, which might be helpful while debugging.
        treeShaking: false,
        // These are directly imported via import statements and should not be bundled.
